...
function getContext(audioContextRef: MutableRefObject<AudioContext | null>) {
...
export function useBattleSound(events: BattleAnimationEvent[], reducedSound = false) {
