...
export const DEFAULT_GAME_QUEST_CHAINS: GameQuestChainDefinition[] = [
    {
        ...
        steps: [
            ...
            },
            {
                ...
                reward: { gold: 15, exp: 15, itemIds: ["use_vital_vial"] },
            },
            {
                id: "submit_week",
                icon: "📙",
        ...
        steps: [
            {
                ...
                condition: { kind: "quest_claimed", questType: "daily", questId: "quest_checkin" },
                reward: { gold: 15, exp: 20, itemIds: ["use_vital_vial"] },
            },
        ],
    },
    {
        ...
        steps: [
            {
                ...
                reward: { gold: 10, exp: 15, itemIds: ["use_charge_capsule"] },
            },
            {
                id: "first_battle",
                icon: "⚔️",
                ...
                reward: { gold: 30, exp: 45, itemIds: ["use_vital_vial"] },
            },
            {
                id: "first_win",
                icon: "🏆",
                ...
                reward: { gold: 50, exp: 75, itemIds: ["reward_lucky_coin"], skillIds: ["garuda-flame-burst"] },
            },
        ],
    },
];
