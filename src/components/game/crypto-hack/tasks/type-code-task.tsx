    ...
    return (
        <div className="flex flex-col items-center gap-6 w-full max-w-md">
            <h2 className="text-2xl font-bold text-red-500 uppercase tracking-widest animate-pulse">
                {t("cryptoTaskTypeCodeTitle")}
            </h2>
            <div className="text-slate-400 text-sm">{t("cryptoTaskTypeCodeSubtitle")}</div>
            ...
            <form onSubmit={handleSubmit} className="w-full relative">
                <input
                    ...
                    placeholder={t("cryptoTaskTypeCodePlaceholder")}
                />
            </form>
