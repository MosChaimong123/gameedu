...
function MonsterSprite({ icon, side, isAttacking, isHurt, isFainted, glowColor }: MonsterSpriteProps) {
    ...
    return (
        ...
        >
            ...
            <motion.div
                animate={isFainted ? {} : { y: [0, isPlayer ? -4 : -6, 0] }}
    ...
    return (
        <div className="relative w-full overflow-hidden rounded-[1.5rem] select-none" style={{ aspectRatio: "16/9", minHeight: 200, maxHeight: 320 }}>
            ...
            <div className="absolute inset-0">
                {/* Player — bottom center-left lane */}
                <div className="absolute bottom-[10%] left-[35%] -translate-x-1/2 sm:left-[37%] md:left-[39%]">
                    <MonsterSprite
                ...
                {/* Opponent — upper center-right lane */}
                <div className="absolute top-[16%] right-[35%] translate-x-1/2 sm:right-[37%] md:right-[39%]">
                    <MonsterSprite
