...
exports.SET_DISPLAY_TH = exports.EFFECT_DISPLAY_TH = exports.EFFECT_ITEM_BONUSES = void 0;
exports.EFFECT_ITEM_BONUSES = {
...
exports.EFFECT_DISPLAY_TH = {
    GOLD_FINDER: {
        desc: "ได้รับทองเพิ่มขึ้นจากการทำกิจกรรมต่างๆ",
        stats: `💰 โบนัสทองคำ +${Math.round(((_a = exports.EFFECT_ITEM_BONUSES.GOLD_FINDER.goldMultiplier) !== null && _a !== void 0 ? _a : 0) * 100)}%`,
    },
    QUICK_LEARNER: {
        desc: "ได้รับค่าประสบการณ์ (EXP) เพิ่มขึ้น",
        stats: `🌟 โบนัส EXP +${Math.round(((_b = exports.EFFECT_ITEM_BONUSES.QUICK_LEARNER.xpMultiplier) !== null && _b !== void 0 ? _b : 0) * 100)}%`,
    },
    TOUGH_SKIN: {
    ...
    LUCKY_STRIKE: {
        ...
        stats: `🍀 CRT +${Math.round(((_c = exports.EFFECT_ITEM_BONUSES.LUCKY_STRIKE.critAdd) !== null && _c !== void 0 ? _c : 0) * 100)}% (เมื่อ LUK > 50%)`,
    },
    MANA_FLOW: {
    ...
    GODS_BLESSING: {
        ...
        stats: `⚡ ทอง +${Math.round(((_d = exports.EFFECT_ITEM_BONUSES.GODS_BLESSING.goldMultiplier) !== null && _d !== void 0 ? _d : 0) * 100)}%, EXP +${Math.round(((_e = exports.EFFECT_ITEM_BONUSES.GODS_BLESSING.xpMultiplier) !== null && _e !== void 0 ? _e : 0) * 100)}%, Boss +${Math.round(((_f = exports.EFFECT_ITEM_BONUSES.GODS_BLESSING.bossDamageMultiplier) !== null && _f !== void 0 ? _f : 0) * 100)}%`,
    },
    TIME_WARP: {
