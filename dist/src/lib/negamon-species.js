...
const ABILITY_ACID_RAIN = { id: "acid_rain", name: "ฝนกรด", desc: "POISON ที่ติดคู่ต่อสู้ไม่หายตลอดเกม" };
const ABILITY_FLAME_BODY = { id: "flame_body", name: "ร่างเพลิง", desc: "10% โอกาสผู้โจมตีติด BURN เมื่อโดนตี" };
const ABILITY_IRON_SHELL = { id: "iron_shell", name: "เกราะเหล็ก", desc: "รับดาเมจลดลง 10% ตลอดเกม" };
...
const ABILITY_AERIAL_STRIKE = { id: "aerial_strike", name: "กระโจนจากฟ้า", desc: "Priority move ทำดาเมจเพิ่ม 20%" };
const ABILITY_STATIC = { id: "static", name: "สายฟ้าสถิต", desc: "15% โอกาสผู้โจมตีติด PARALYZE เมื่อโดนตี" };
