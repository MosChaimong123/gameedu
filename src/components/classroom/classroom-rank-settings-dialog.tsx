        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[700px] w-[96vw] max-h-[90vh] flex flex-col p-0 gap-0 overflow-hidden rounded-2xl shadow-2xl border-0 bg-[#F4F6FB]">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-4">
                    <div className="grid grid-cols-[48px_1fr_90px_90px] items-center gap-3 px-2 text-[11px] font-bold text-slate-400 uppercase tracking-wider">
                    ...
                    <div className="space-y-2">
                        {ranks.map((rank, i) => (
                            <div key={i} className="relative">
                                <div className="grid grid-cols-[48px_1fr_90px_90px] items-center gap-3 bg-white rounded-xl px-3 py-2.5 shadow-sm border border-slate-200">
