...
const QUEST_ID_NAME_KEYS: { id: string; nameKey: string }[] = [
...
const CHAIN_STEP_NAME_KEYS: { chainId: string; stepId: string; nameKey: string }[] = [
...
function formatNegamonQuestRewardReason(payload: string, t: TranslateFn): string | null {
