...
exports.normalizeJobClassName = normalizeJobClassName;
...
function normalizeJobClassName(className) {
...
function isValidJobClass(className) {
    return exports.ALL_JOB_CLASSES.includes(normalizeJobClassName(className));
}
