                ...
                <div className="p-6 pt-8 space-y-8 bg-gradient-to-b from-white to-slate-50/50 relative">
                    ...
                    <div className="space-y-8 pt-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-center -mb-1">
                                    <span className="text-sm font-black text-indigo-600 tabular-nums whitespace-nowrap">
                                        ...
                                        {rankProgress.nextRank ? formatAmount(points + rankProgress.pointsNeeded) : formatAmount(points)}
                                    </span>
                                </div>
                                <div className="h-4 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 shadow-inner">
                                    <motion.div
                                        initial={{ width: 0 }}
                                        animate={{
                                            width: `${rankProgress.nextRank
                                                ? Math.min(100, (points / (points + rankProgress.pointsNeeded)) * 100)
                                                : 100}%`
                                        }}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-center -mb-1">
                                    <span className="text-sm font-black text-amber-600 tabular-nums whitespace-nowrap">
                                        {formatAmount(behaviorPoints)} <span className="text-slate-300 font-bold ml-1">PTS</span>
                                    </span>
                                </div>
                                <div className="h-4 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 shadow-inner">
                                    <motion.div
                        ...
                        {rankProgress.nextRank && (
                            ...
                            >
                                <p className="text-sm font-bold text-indigo-700 uppercase tracking-wide flex items-center justify-center gap-3 flex-wrap">
                                    {t("needMore") || "อีก"}
