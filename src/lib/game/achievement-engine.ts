...
export interface StudentStats {
  ...
  academicTotal: number;    // Academic score
  bossesDefeated: number;   // Times participated in boss defeat (from history)
  itemsBought: number;      // StudentItems count
 ...
 */
export async function checkAndGrantAchievements(studentId: string): Promise<AchievementDef[]> {
