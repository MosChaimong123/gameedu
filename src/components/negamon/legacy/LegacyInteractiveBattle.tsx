...
import { effectiveStat, normalizeBattleFighterTurns } from "@/lib/battle-engine";
...
interface LegacyInteractiveBattleProps {
...
export function LegacyInteractiveBattle({
    initialPlayer,
    initialOpponent,
    myId,
    classId,
