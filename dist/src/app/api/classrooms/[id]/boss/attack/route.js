...
async function POST(req, { params }) {
    ...
    try {
        ...
        const student = await db_1.db.student.findFirst({
            ...
            select: { id: true, gameStats: true, jobClass: true, jobSkills: true }
        });
        if (!student) {
        ...
        if (xpResult.leveledUp && student.jobClass) {
            ...
            const newSkills = (0, job_system_1.getNewlyUnlockedSkills)(student.jobClass, currentStats.level, xpResult.level, currentSkillIds);
