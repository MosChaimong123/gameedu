...
async function POST(req, { params }) {
    ...
    try {
        ...
        // Resolve battle
        const challengerEff = (0, job_system_1.resolveEffectiveJobKey)({
            jobClass: battle.challenger.jobClass,
            jobTier: battle.challenger.jobTier,
            advanceClass: battle.challenger.advanceClass,
        });
        const defenderEff = (0, job_system_1.resolveEffectiveJobKey)({
            jobClass: defender.jobClass,
            jobTier: defender.jobTier,
            advanceClass: defender.advanceClass,
        });
        const { challengerRoll, defenderRoll, winnerId } = (0, battle_engine_1.resolveBattle)(battle.challengerId, challengerStats, defender.id, defenderStats, (0, job_system_1.getPvpMatchupBaseClass)(challengerEff), (0, job_system_1.getPvpMatchupBaseClass)(defenderEff));
