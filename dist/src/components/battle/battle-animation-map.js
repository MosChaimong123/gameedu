...
exports.resolveSkillVisual = resolveSkillVisual;
exports.resolveEnemyAttackVisual = resolveEnemyAttackVisual;
...
function resolveSkillVisual(skillId) {
    var _a, _b;
    if (!skillId)
    ...
    const effect = (_a = skill.effect) !== null && _a !== void 0 ? _a : "DAMAGE";
    const visualByEffect = {
        DAMAGE: {
            label: skill.name,
            effect,
            preset: skill.damageBase === "MAG" ? "arcane" : "slash",
            colorClass: skill.damageBase === "MAG"
    ...
    return (_b = visualByEffect[effect]) !== null && _b !== void 0 ? _b : {
        ...fallbackVisual,
        label: skill.name,
        effect,
    };
}
function resolveEnemyAttackVisual(enemyName, mode, damage) {
