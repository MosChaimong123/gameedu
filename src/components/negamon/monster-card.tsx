...
import type { MonsterType, NegamonSettings, StudentMonsterState, MonsterMove } from "@/lib/types/negamon";
import {
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {monster.unlockedMoves.map((move) => {
                                            const typeStyle =
                                                NEGAMON_MOVE_TYPE_BADGE[move.type] ??
                                            ...
                                            const energyCost =
                                                move.energyCost ?? getMoveEnergyCost(move, monster.speciesId);
                                            return (
                                                <div
                                                    key={move.id}
                                                ...
                                                >
                                                    ...
                                                    <NegamonMoveInlineDescription t={t} move={move} />
                                                </div>
                                            );
                                        })}
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {lockedMoves.map((move) => {
                                            ...
                                            return (
                                                <div
                                                    key={move.id}
                                                    className="rounded-xl border-2 border-dashed border-stone-300/70 bg-stone-100/50 p-2.5 opacity-90"
                                                >
                                                    <div className="mb-1 flex items-center gap-1.5">
                                                        <Lock className="h-3 w-3 shrink-0 text-stone-400" />
                                                        <p className="line-clamp-2 min-w-0 flex-1 text-[11px] font-black text-stone-600">
                                                            {negamonMoveDisplayName(t, move)}
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div className="mt-1.5 flex items-center justify-between text-[9px] font-bold text-stone-500">
                                                        ...
                                                        <span>
                                                            EN{" "}
                                                            <span className="text-cyan-700">{energyCost}</span>
                                                        </span>
                                                    </div>
                                                    ...
                                                    <NegamonMoveInlineDescription
                                                        t={t}
                                                        move={move}
                                                        className="border-stone-300/50 text-stone-600"
                                                    />
                                                </div>
                                            );
                                        })}
...
export function PassiveSkillsPanel({ loginCode, gold, negamonSkills, onSkillUnlocked }: PassiveSkillsPanelProps) {
    const { t } = useLanguage();
